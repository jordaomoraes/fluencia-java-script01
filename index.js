...
// const numberLess501 = crazyNumbers.reduce((acumalador,crazyNumbers)=>{
// if(crazyNumbers < 501){
//   acumalador +=1;
// }
// return acumalador
...
// const numbersQuadrado = numbers.map(number => Math.pow(number,2))
...
// const yearLess200 = tarantinoMovies.filter(movie => {
...
// const justNamesTvShow = tvShows.map(names => {
//   return { name : names.name}
// })

// aqui tbm funciona
// const justNamesTvShow = tvShows.map(names => names.name)


// console.log(tvShows)
// console.log(justNamesTvShow)
...
const productList = cart.reduce((acumulator, product) => {

return `${acumulator}- ${product.name}\n`
